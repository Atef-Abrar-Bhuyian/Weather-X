...
const Home = () => {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col top-40 h-full text-center px-4">
        {/* Heading */}
        ...
        {/* Search Box */}
        <div className="bg-white/30 backdrop-blur-md py-2 px-4 rounded-full shadow-2xl flex items-center space-x-4 transition-all duration-300 hover:scale-105 w-2/4 mx-auto">
